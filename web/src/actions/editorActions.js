...
import DecoRangeUtils from '../utils/editor/DecoRangeUtils.js'
import DecoComponentUtils from '../utils/editor/DecoComponentUtils.js'
import LiveValueUtils from '../utils/metadata/LiveValueUtils.js'
import LiveValueGroupUtils from '../utils/metadata/LiveValueGroupUtils.js'
import uuid from '../utils/uuid'
import { markSaved } from './fileActions.js'
import { createHistory, addToHistory, undoFromHistory, redoToHistory } from './historyActions.js'
import { setLiveValueIds, createLiveValue, setLiveValues, importLiveValues } from './liveValueActions.js'
import { loadMetadata } from './metadataActions.js'
import { save, saveLive } from './applicationActions.js'
import { CATEGORIES, PREFERENCES } from '../constants/PreferencesConstants.js'
...
export const insertTemplate = (decoDoc, text, metadata = {}, imports, groupName) => (dispatch, getState) => {
    ...
    //make preparation for insert doc ,comment by danding
    ...
    //does this statement make actually change?
    dispatch(edit(decoDoc.id, insertChange))
