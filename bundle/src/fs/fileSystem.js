...
var getPath = function getPath(pathType, relativePath) {
    try {
...
var getRelativePath = function getRelativePath(relativePath) {
    return path.join(__dirname, relativePath);
};

FileSystem.prototype.getAppPath = getPath.bind(undefined, 'appData');
FileSystem.prototype.getTmpPath = getPath.bind(undefined, 'temp');
FileSystem.prototype.getHomePath = getPath.bind(undefined, 'home');
...
FileSystem.prototype.copyDirectorySync = function (copyAbsolutePath, pasteAbsolutePath) {
    var recursiveCopy = function recursiveCopy(copyDir, pasteDir) {
